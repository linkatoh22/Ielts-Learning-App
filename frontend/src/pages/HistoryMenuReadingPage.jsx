...
import { fetchGetAllSubmitTest } from "../redux/thunk/readingThunk";
...
export default function HistoryReadingMenuPage(){
    const { loading,exam } = useSelector(s => s.reading)
    ...
    return(
        <Box sx={{width:"75%",display:"flex",flexDirection:"column",gap:2,margin:"auto",pb:4,minHeight:"75vh",justifyContent:"center"}}>
            <Typography variant="h4" sx={{fontWeight:"bold",color:"var(--success-700)"}}>Lịch sử luyện thi Reading</Typography>
                <Divider></Divider>
