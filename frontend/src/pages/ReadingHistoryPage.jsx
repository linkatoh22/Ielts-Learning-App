...
import { fetchGetDetailSubmitTest } from "../redux/thunk/readingThunk";
...

                {
                    ...
                    <Box width={"100%"}>
                        <Box sx={{display:"flex",py:2}}>
                            <ExerciseAnswer 
                                partOne={examDetail?.passageId?.questionsPartOne}
                                partTwo={examDetail?.passageId?.questionsPartTwo}
                                partThree={examDetail?.passageId?.questionsPartThree}
